...
import Img2 from '../asset/dev.jpg'
...
function Discuss(props) {
    ...
    return (
        <div style={{ display: 'flex', flexDirection: "row", padding: "5% 8%",width:"100vw" }} >
            <Box sx={{
            ...
            <Box sx={{ width: "100%", display: "flex", flexDirection: "row", justifyContent: "space-between", alignItems: "center", gap: "20px", '@media(max-width:425px)': { flexWrap: "wrap" } }} >
                ...
                <Box sx={{
                    ...
                    <img src={Img2} alt="Profile" width="200" height="250" style={{ objectFit: "cover", borderRadius: "50%", border: "2px dashed red", padding: "10px" }} />
                </Box>
