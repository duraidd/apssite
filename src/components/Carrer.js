  ...
  const CareerDataList = [
    {
      details: {
        ...
        description: [
          "Design and create user-friendly interfaces for web and mobile applications.",
          "Develop wireframes, prototypes, and high-fidelity mockups.",
          "Collaborate with product managers, developers, and other stakeholders to gather requirements and translate them into intuitive designs.",
          "Conduct user research and usability testing to refine designs based on user feedback.",
          "Implement design elements using front-end technologies, with a focus on seamless user experiences.",
          "Utilize Python for tasks related to design automation, data visualization, or integrating UI/UX designs with back-end systems.",
      ...
      cardData: ["1-2 years experience", "Any Degree/Diploma"],
    },
