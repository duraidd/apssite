    ...
    <Box sx={{ display: "flex" }}>
      ...
      >
        <Toolbar>
          ...
          <Box sx={{ flexGrow: 1, display: { xs: "none", sm: "block" }, color: "black", paddingTop: '8px', marginRight: '1px' ,cursor:'pointer' }}>
            <img src={Logoimg} alt="logo" width={'180px'} height={'50px'} onClick={()=>navigate('/')} />
          </Box>
