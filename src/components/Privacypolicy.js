        ...
        <>
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', gap: '50px' }} >
                ...
                <Box sx={{padding:'0px 10%',fontFamily:'Plus Jakarta Sans'}}>
                    ...
                    <span style={{color:"#ff0400" ,fontFamily:'Plus Jakarta Sans', fontWeight:'bold' }}  >1.Information Collection and Usage</span><br/><br/>
                    <span style={{color:"#ff0400" ,fontFamily:'Plus Jakarta Sans' }}  >1.1 Registration and Personal Information</span><br/>
                    ...
                    <span style={{color:"#ff0400" ,fontFamily:'Plus Jakarta Sans' }}>1.2 Cookies</span><br/>
                    ...
                    <span style={{color:"#ff0400" ,fontFamily:'Plus Jakarta Sans' }}>1.3 User Communications</span><br/>
                    ...
                    <span style={{color:"#ff0400" ,fontFamily:'Plus Jakarta Sans' }}>1.4 Log Information</span><br/>
                    ...
                    <span style={{color:"#ff0400" ,fontFamily:'Plus Jakarta Sans' }}>1.5 Electronic Newsletter/E-mail</span><br/>
                    APS Technologies offers a free electronic newsletter to users who voluntarily subscribe. You can opt-out of this mailing list at any time by following the unsubscribe link provided in each newsletter.<br/><br/>
                    <span style={{color:"#ff0400" ,fontFamily:'Plus Jakarta Sans', fontWeight:'bold' }}  >2. Confidentiality and Data Protection</span><br/>
                    ...
                    <span style={{color:"#ff0400" ,fontFamily:'Plus Jakarta Sans', fontWeight:'bold' }}  >3. Feedback</span><br/>
                    ...
                    <span style={{color:"#ff0400" ,fontFamily:'Plus Jakarta Sans', fontWeight:'bold' }}  >4. Continuous Improvement</span><br/>
